...
#define BATT_MAX		2552//12.4V	値は12.4v(たぶん)　HV 2cellの最高は8.7v
#define BATT_MIN		2034//10V	値は10v	HV 2cell は7.2vが20% 8.6vが50%
...
#define MOT_R1_FORWARD	(0)			//モータドライバのCWCCW端子にLOWを出力すると前進する
#define MOT_R1_BACK	(1)			//モータドライバのCWCCW端子にHIGHを出力するとバックする#define MOT_FORWARD	(0)			//モータドライバのCWCCW端子にLOWを出力すると前進する
#define MOT_R2_FORWARD	(1)			//モータドライバのCWCCW端子にLOWを出力すると前進する
#define MOT_R2_BACK	(0)			//モータドライバのCWCCW端子にHIGHを出力するとバックする

#define MOT_L1_FORWARD	(1)			//モータドライバのCWCCW端子にLOWを出力すると前進する
#define MOT_L1_BACK	(0)			//モータドライバのCWCCW端子にHIGHを出力するとバックする#define MOT_FORWARD	(0)			//モータドライバのCWCCW端子にLOWを出力すると前進する
#define MOT_L2_FORWARD	(0)			//モータドライバのCWCCW端子にLOWを出力すると前進する
#define MOT_L2_BACK	(1)			//モータドライバのCWCCW端子にHIGHを出力するとバックする
