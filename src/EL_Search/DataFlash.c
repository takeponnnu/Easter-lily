...
void hw_dflash_init(void)
{
	...
	FLASH.DFLRE0.WORD = 0x2D03;	// block read enable E2データフラッシュ読み出し許可レジスタ
	FLASH.DFLWE0.WORD = 0x1E03;	// block P/E enable E2データフラッシュP/E許可レジスタ
