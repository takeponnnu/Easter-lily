...
void fast_run(int x, int y, int mode)
{
//引数の座標x,yに向かって最短走行する
	...
	//if( n == 0){ straight(HALF_SECTION+20,FAST_ACCEL,FAST_SPEED,FAST_SPEED); n++; }
	...
	if(mode==1)	straight(SECTION*straight_count,FAST_ACCEL,FAST_SPEED,0.0);
	else if(mode==2)straight(SECTION*straight_count,FAST_ACCEL,FAST_SPEED1,0.0);
	else if(mode==3)straight(SECTION*straight_count,FAST_ACCEL1,FAST_SPEED1,0.0);
	else if(mode==4)straight(SECTION*straight_count,FAST_ACCEL,FAST_SPEED2,0.0);
	else if(mode==5)straight(SECTION*straight_count,FAST_ACCEL1,FAST_SPEED2,0.0);
}
