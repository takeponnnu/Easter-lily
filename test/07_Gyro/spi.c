...
void init_spi_gyro(void)
{
	...
	*****************************************************************************************/
	...
	PORT2.PMR.BIT.B6 =	0x01;	//P26を周辺機能として使用
	PORT3.PMR.BIT.B0 =	0x01;	//P30を周辺機能として使用
	PORT3.PMR.BIT.B1 =	0x01;	//P31を周辺機能として使用
	...
	MPC.P26PFS.BIT.PSEL=	0x0D;	//P26をMOSIBとして利用
	MPC.P30PFS.BIT.PSEL=	0x0D;	//P30をMISOBとして利用
	MPC.P31PFS.BIT.PSEL=	0x0D;	//P31をSSLBBとして利用
